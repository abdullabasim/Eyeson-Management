                ...
                <div class="col-md-8 col-md-offset-2">
                    ...
                    <div class="box box-primary">
                        <div class="box-header with-border">
                            <h3 style="float: right" class=" font box-title">أضافة فاتورة</h3>
                        </div>
                        <!-- /.box-header -->
                        <!-- form start -->
                        @include('alertMessages.alertMessages')
                            <div class="box-body">
                                <form method="post" action="{{url('sessionAdd')}}">
                                    @csrf
                                    <!-- /.box-header -->
                                    <div class="box-body">
                                            ...
                                            <input type="hidden" id="dep" name="department" value="" >
                                        <br>
                                        ...
                                        <div class="row prices">
                                                                                  ...
                                                                                  <div  style="padding-left: 10px;padding-right: 10px;margin-bottom: 40px" class="form-group">
                                                                                         <label style="float: right;margin-top: 5px;" for="exampleInputEmail1">  المبلغ الاجمالي </label>
                                                                                             ...
                                                                                             <input type="text"   readonly  id="totalPrice"  name="totalPrice"  class="form-control input-lg "  style="float: right;text-align:right !important ; direction: rtl ;margin-left: 90px !important;" placeholder="المبلغ الاجمالي">
                                        ...
                                        <div class="row prices">
                                            ...
                                            <div  style="padding-left: 10px;padding-right: 10px;margin-bottom: 40px" class="form-group">
                                                ...
                                                <input type="text" id="paid" required     name="paid"  class="form-control input-lg "  style="float: right;text-align:right !important ; direction: rtl ;margin-left: 90px !important;" placeholder=" ادخل المبلغ المدفوع">
                                        ...
                                        <div class="row prices">
                                            ...
                                            <div  style="padding-left: 10px;padding-right: 10px;margin-bottom: 40px" class="form-group">
                                                ...
                                                <input type="text" required   readonly  id=remindings"  name="reminding"  class="form-control input-lg reminding "  style="float: right;text-align:right !important ; direction: rtl ;margin-left: 90px !important;" placeholder="0" >
    ...
    <div class="modal-dialog modal-sm">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 style="text-align: right" class="modal-title font">الديون</h4>
            </div>
            <div class="modal-body">
                <p id="dept" style="text-align: right"> </p>
...
<script>
        ...
        $.ajax({
            ...
            success: function (data) {
               ...
               if(data != "0")
               {
                   ...
                   $("#dept").text("توجد ديون سابقة على هذا الزبون بمقدار" +  ' ' + data +' '+ "د.ع" );
               }
    ...
    $("#paid").change(function (e){ //user click on remove text
